...
var DropzoneS3Uploader = (function (_React$Component) {
  ...
  function DropzoneS3Uploader(props) {
    ...
    this.onModify = function (files, rejectedFiles) {
      ...
      if (_this.props.onModify && !_this.props.multiple) {
        _this.props.onModify(files, rejectedFiles, function (modifiedFiles, rejectedFiles) {
          _this.handleDrop(modifiedFiles, rejectedFiles);
        });
      } else {
        _this.handleDrop(files, rejectedFiles);
      }
    };
  ...
  DropzoneS3Uploader.prototype.render = function render() {
    ...
    return _react2['default'].createElement(
      ...
      _extends({ ref: function (c) {
        ...
        }, onDrop: this.onModify }, dropzoneProps),
      content
    );
  };
