...
var DropzoneS3Uploader = (function (_React$Component) {
  ...
  function DropzoneS3Uploader() {
    ...
    this.handleDrop = function (files, rejectedFiles) {
      ...
      if (_this.props.onModify && !_this.props.multiple) {
        _this.props.onModify(files, rejectedFiles, function (modifiedFiles, rejectedFiles) {
          if (modifiedFiles) _this.handleUpload(modifiedFiles, rejectedFiles);
        });
      } else {
        _this.handleUpload(files, rejectedFiles);
      }
    };

    this.handleUpload = function (files, rejectedFiles) {
  ...
  _createClass(DropzoneS3Uploader, null, [{
    ...
    value: {
      ...
      onModify: _react.PropTypes.func,
